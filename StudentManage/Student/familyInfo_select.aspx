<%@ Page Language="C#" AutoEventWireup="true" CodeFile="familyInfo_select.aspx.cs" Inherits="Student_familyInfo_select" %>
    ...
    <div class="layui-form-item">
        <asp:Button ID="Button_select" runat="server" Text="查询" CssClass="layui-btn" OnClick="Button_select_Click"/>
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
             ...
             UpdateCommand="UPDATE [家庭信息表] SET [学号] = @学号, [姓名] = @姓名, [父亲姓名] = @父亲姓名, [母亲姓名] = @母亲姓名, [父亲电话] = @父亲电话, [母亲电话] = @母亲电话, [家庭成员总数] = @家庭成员总数, [家庭地址] = @家庭地址 WHERE WHERE [学号] = @original_xh AND [姓名] = @original_xm AND [父亲姓名] = @original_fqxm AND [母亲姓名] = @original_mqxm AND [父亲电话] = @original_fqphone AND [母亲电话] = @original_mqphone AND [家庭成员总数] = @original_all AND [家庭地址] = @original_address" 
