<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stumima_alter.aspx.cs" Inherits="Teacher_stumima_alter" %>
...
<body>
    <form id="form1" runat="server" class="layui-form" style="margin-left:50px; margin-top:40px;">
        ...
        <div class="layui-input-block" style="width:300px;">
            <asp:TextBox ID="TextBox2" runat="server" CssClass="layui-input" placeholder="请输入新密码" TextMode="Password"></asp:TextBox>
        </div>
     </div>
    ...
    <div class="layui-form-item">
      <label class="layui-form-label">确认密码<i>*</i></label>
        <div class="layui-input-block" style="width:300px;">
            <asp:TextBox ID="TextBox3" runat="server" CssClass="layui-input" placeholder="请确认密码" TextMode="Password"></asp:TextBox>
        </div>
    </div>
