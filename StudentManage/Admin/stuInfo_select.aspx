<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stuInfo_select.aspx.cs" Inherits="Admin_stuInfo_select" %>
...
<body>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="width:100px;">
            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="layui-select" >
                <asp:ListItem>--请选择学号--</asp:ListItem>
            </asp:DropDownList>
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="width:100px;">
            <asp:DropDownList ID="DropDownList2" runat="server" CssClass="layui-select">
                <asp:ListItem>--请选择姓名--</asp:ListItem>
            </asp:DropDownList>
     ...
     <div class="layui-form-item">
        <asp:Button ID="Button_select" runat="server" Text="查询" CssClass="layui-btn" OnClick="Button_select_Click"/>
         ...
         <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="xh" DataSourceID="SqlDataSource1"  CssClass="layui-table" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:学生信息管理系统ConnectionString %>"
             DeleteCommand="DELETE FROM [student] WHERE [xh] = @original_xh AND [xm] = @original_xm AND [xb] = @original_xb AND [sr] = @original_sr AND [grade] = @original_grade AND [mz] = @original_mz AND [jg] = @original_jg AND [zy] = @original_zy AND [phone] = @original_phone"
              InsertCommand="INSERT INTO [student] ([xh], [xm], [xb], [sr], [grade], [mz], [jg], [zy], [phone]) VALUES (@xh, @xm, @xb, @sr, @grade, @mz, @jg, @zy, @phone)" 
               SelectCommand="SELECT [xh], [xm], [xb], [sr], [grade], [mz], [jg] , [zy], [phone]FROM [student]" 
